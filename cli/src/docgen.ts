...
// regenerating the page (make gen-docs, release.sh) is reproducible and does
...
export function renderManPage(spec: CliSpec = CLI_SPEC): string {
  ...
  out.push(`.\\" regenerate with: ${spec.name} man  (or make gen-docs).`);
  out.push(
...
#   Generated by \`${spec.name} completions bash\` from cli/src/cli-spec.ts;
...
export function renderZshCompletion(spec: CliSpec = CLI_SPEC): string {
  ...
  lines.push(
    `#   Generated by \`${spec.name} completions zsh\` from cli/src/cli-spec.ts;`,
  );
  lines.push("#   do not edit by hand. Regenerate with `make gen-docs`.");
  lines.push("#");
...
export function renderFishCompletion(spec: CliSpec = CLI_SPEC): string {
  ...
  lines.push(
    `#   Generated by \`${spec.name} completions fish\` from cli/src/cli-spec.ts;`,
  );
  lines.push("#   do not edit by hand. Regenerate with `make gen-docs`.");
  lines.push("#");
