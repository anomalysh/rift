...
## [0.2.0](https://github.com/anomalysh/rift/compare/v0.1.0...v0.2.0) (2026-07-10)
...
* **cli:** log a "connected" event when the tunnel comes online ([3f48c98](https://github.com/anomalysh/rift/commit/3f48c9823158b8b65815b0feacae3e417d3cffa3))
* **cli:** named multi-tunnel project config with rift start (D3) ([47b7747](https://github.com/anomalysh/rift/commit/47b7747103fce460492d6058236687cc034971e6))
...
* **domains:** bring-your-own custom domains with on-demand TLS (E1) ([c1a70a4](https://github.com/anomalysh/rift/commit/c1a70a489631885734f554495db8d36f635921a5))
* **gateway:** tune raw-tunnel sockets with TCP_NODELAY and keep-alive (P1) ([33ca242](https://github.com/anomalysh/rift/commit/33ca242f3461da4f208bc8ef07cb4dfee96687a9))
...
* **grpc:** gRPC tunnels over h2c with :authority routing (P7) ([193520d](https://github.com/anomalysh/rift/commit/193520d5b4c25c1c98468c66c3d8ab7b9a9166be))
...
* **policy:** per-tunnel lifetime bounds and rate limiting (A4-A5) ([d4c3c52](https://github.com/anomalysh/rift/commit/d4c3c52d7544fcf280c066a1958debeeb36c8374))
* **policy:** visitor-access foundation — basic-auth + IP allow/deny (A1-A3) ([eb96530](https://github.com/anomalysh/rift/commit/eb965309c1cd9abbc82d62e6e173696b17080f17))
...
* **tools:** restructure operator toolchain, publish raw-tunnel ports, add riftd config tooling ([2fd3064](https://github.com/anomalysh/rift/commit/2fd3064b67268ccf7d94bdbcfa9498b6cc7fc4ce))
* **traffic:** agent-side traffic policy and branded error pages (T1-T6) ([4965fd7](https://github.com/anomalysh/rift/commit/4965fd75f5df0a1ea758a821b2179ed3fbe20ca4))
...
* **udp:** raw UDP tunnels over length-delimited datagram streams (P4) ([a2d8c30](https://github.com/anomalysh/rift/commit/a2d8c3085d0943c3127de7b35b30e5df9a01c1e4))
...
* **build:** commit riftd config tooling that .gitignore silently swallowed ([ce98775](https://github.com/anomalysh/rift/commit/ce9877512b1bc12353425b3f0adb99a6d41ed70f))
...
* **mise:** cli:build sandbox failed on a fresh checkout ([2576661](https://github.com/anomalysh/rift/commit/2576661cae43889ba37244cf2eefa74d44351112))
...
* **examples:** add http-demo and mcp-server projects to tunnel with rift ([bffa41e](https://github.com/anomalysh/rift/commit/bffa41e3e7206ec8ccaa6fde6a85e99f543b2ee3))
